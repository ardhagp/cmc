...
Namespace VisualInheritanceFixer
    ...
    Public Class MSS
        ...
        <Description("Set this to the base forms StatusStrip. If you can't find it, make sure it's modifer is set to to 'protected' or greater.")> _
        <Category("Behavior")> _
        Public Property InheritedToolStrip() As StatusStrip
            Get
                Return TryCast(_fixer.InheritedToolStrip, StatusStrip)
            End Get
            Set(value As StatusStrip)
                _fixer.InheritedToolStrip = TryCast(value, StatusStrip)
            End Set
        End Property
