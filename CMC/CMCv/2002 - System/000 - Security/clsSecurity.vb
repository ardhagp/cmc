...
Namespace Security
    Public Class Engine
        ''' <summary>
        ''' Engine (SDP) adalah Securing Data Process. Berfungsi untuk mengamankan data anda.
        ''' 
        ''' </summary>
        ''' <remarks></remarks>
...
#Region "Public Functions"
        ...
        Public Shared Function EncryptFile(ByVal Filename As String, ByVal Target As String) As Boolean
            Dim _File As New CMCv.OperatingSystem.File.Info
            If Not _File.IsExists(Filename) Then
